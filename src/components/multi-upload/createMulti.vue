    ...
    <div class="d-flex align-items-baseline">
        <div class="d-flex me-3">
            <div v-for="(prev, index) in preview" :key="index">
                <div class="me-1">
                    <img :src="prev" :class="img_mc_style.border" :height="img_mc_style.height" :width="img_mc_style.width">
                </div>
                <div class="d-flex justify-content-between mt-1 align-items-baseline">
                    <div>
                        <label for="mcfile" class="text-primary btn-sm btn fs-7" title="Upload image">
                            <input type="file" id="mcfile" name="mcImage" autocomplete="off" @change="changeImage"
                                class="hidden">
            ...
            <div v-show="disinit">
                <div>
                    <img :src="default_img" :class="img_mc_style.border" :height="img_mc_style.height"
                        :width="img_mc_style.width">
                </div>
                <div>
